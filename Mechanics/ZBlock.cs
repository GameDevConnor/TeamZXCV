...
public class ZBlock : MonoBehaviour
{
    Vector2 moveDirVel;
    Rigidbody2D rb;
    ...
    {
        if (collision.collider.CompareTag("PlayerZ"))
        {
        ...
        else if (collision.collider.CompareTag("PlayerV"))
        {
            audioManager.StopAllExcept("Music");
